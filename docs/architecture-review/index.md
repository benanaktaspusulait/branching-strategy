...
| Area | File |
| --- | --- |
| Source document list | [source-document-list](source-document-list.md) |
...
3. [arb-package](arb-package.md)
4. [business-case-and-roadmap](business-case-and-roadmap.md)
5. [operating-model-raci](operating-model-raci.md)
6. [criticality-challenge-review](criticality-challenge-review.md)
7. [missing-enterprise-concerns](missing-enterprise-concerns.md)
8. [final-scorecard-and-verdict](final-scorecard-and-verdict.md)
